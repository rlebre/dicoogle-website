...
const Slider = () => {
  ...
  return (
    <div id='carouselExampleIndicators' className='slide mt-20' data-bs-ride='carousel'>
      ...
      <div className='carousel-inner relative w-full overflow-hidden'>
        <div className='carousel-item active float-left w-full'>
          <img src='https://mdbcdn.b-cdn.net/img/new/slides/041.webp' className=' w-full' alt='Wild Landscape' />
        </div>
        <div className='carousel-item float-left w-full hidden'>
